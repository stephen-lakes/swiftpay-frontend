...
const Navbar = () => {
    ...
    const handleClick = (screen: string) => {
        setActiveTab(screen)
        navigate(screen === "home" ? "/dashboard" : `/dashboard/${screen}`);
  ...
  return (
    <>
        ...
        {/* <div className="min-w-[272px] p-3 flex items-center justify-around fixed bottom-2 left-1 right-1 bg-purple-400 rounded-full"> */}
        <div className="w-full p-3 flex items-center justify-around fixed bottom-0 left-0 right-0 bg-[#f3f4f6] shadow-2xl">
            ...
            <div onClick={() => handleClick("home")} className="cursor-pointer flex flex-col items-center">
                <div>
                    {activeTab === "home" ? 
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            >
                                <g fill="none" stroke="purple" strokeWidth="2">
                                <path
                                    strokeLinecap="round"
                ...
                <div className={`text-xs${activeTab === "home" ? "font-semibold text-purple-600": ""}`}>Home</div>
            </div>
            ...
            <div onClick={() => handleClick("cards")} className=" cursor-pointer flex flex-col items-center">
                <div>
                    {activeTab === "cards" ? <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="purple" d="M5 5h13a3 3 0 0 1 3 3v9a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3V8a3 3 0 0 1 3-3m0 1a2 2 0 0 0-2 2v1h17V8a2 2 0 0 0-2-2zM3 17a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2v-5H3zm2-1h4v1H5zm6 0h3v1h-3zm-8-6v1h17v-1z"/>
                        </svg>
                    :
                        <img src={CreditCardIcon} alt="" />
                    }
                </div>
                <div className={`text-xs ${activeTab === "cards" ? "font-semibold text-purple-600": ""}`}>Cards</div>
            </div>
            ...
            <div onClick={() => handleClick("profile")} className="cursor-pointer flex flex-col items-center">
                ...
                <div className={`text-xs ${activeTab === "profile" ? "font-semibold text-purple-600": ""}`}>Profile</div>
            </div>
